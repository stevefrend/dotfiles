...
-- Keep signcolumn on by default (column for icons etc next to numbers)
...
require('lazy').setup({
  ...
  {
    -- Emmet type auto-closing tags for html etc
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      icons = {
        -- sets icon mappings to true if you have a Nerd Font (based on var higher up)
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sn', builtin.find_files, { desc = '[S]earch [N]ormal' })
  ...
  { -- Enable better commenting (fixes broken comments in Vue <template>)
